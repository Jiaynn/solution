...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'output/whiteboard.data';
      var REMOTE_PACKAGE_BASE = 'whiteboard.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_output/whiteboard.data');

      };
      Module['addRunDependency']('datafile_output/whiteboard.data');
...
var wasmBinaryFile = 'whiteboard.wasm';
...
var ASM_CONSTS = {
  ...
  function _call_js(ptr,len,ptr1,len1)  {
         ...
         const view1 = new Uint8Array(wasmMemory.buffer, ptr1, len1);
         let string1 = '';
         for (let i = 0; i < len1; i++) {
         string1 += String.fromCharCode(view1[i]);
         }
                                                  
         window.call_js(string,string1);                                      
      }
  ...
  var EGL={errorCode:12288,defaultDisplayInitialized:false,currentContext:0,currentReadSurface:0,currentDrawSurface:0,contextAttributes:{alpha:true,depth:false,stencil:false,antialias:false},stringCache:{},setErrorCode:function(code) {
        EGL.errorCode = code;
...
/** @type {function(...*):?} */
var _get_input_str = Module["_get_input_str"] = createExportWrapper("get_input_str");

/** @type {function(...*):?} */
var _set_params_length = Module["_set_params_length"] = createExportWrapper("set_params_length");

/** @type {function(...*):?} */
var _receive_websocket_message = Module["_receive_websocket_message"] = createExportWrapper("receive_websocket_message");

/** @type {function(...*):?} */
var _push_command = Module["_push_command"] = createExportWrapper("push_command");
