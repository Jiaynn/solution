/**
 * @file test local ip address
 * @description
 *  referernce: https://github.com/DylanPiercey/is-local-ip/blob/master/index.js
 */
...
export function isLocalIp(address: string) {
  return localIpRanges.some(it => it.test(address))
}
