...
class InternalHeaderInfo extends React.Component<IProps & DiDeps> {
  ...
  @computed
  get CDNDomains() { // eslint-disable-line @typescript-eslint/naming-convention
  ...
  @computed
  get CDNOptGroupView() { // eslint-disable-line @typescript-eslint/naming-convention
    if (this.isShared) {
      return null
    }
    ...
    const isDefaultDomainCDNType = this.isDefaultDomainAvailable
      && this.defaultDomain && this.defaultDomain.domainType === DomainSourceType.CDN
